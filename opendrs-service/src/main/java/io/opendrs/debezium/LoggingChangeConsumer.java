...
/**
 * Logs SourceRecords only. Production apply uses {@link SinkApplyChangeConsumer}; this class
 * remains as a fallback when no target connection is present and as {@link #extractOp} for tests.
 */
