...
public final class DebeziumEngineConfig {
    ...
    public record EngineSpec(
        ...
        public EngineSpec(long taskId, ConnectionInfo source, List<Table> tables, Long databaseServerId) {
            this(taskId, source, tables, databaseServerId, null, null);
        }

        public static EngineSpec of(
                long taskId, ConnectionInfo source, List<Table> tables, MigrationOptions options) {
            return of(taskId, source, tables, options, null, null);
        }
        ...
        public static EngineSpec of(
            ...
            return new EngineSpec(taskId, source, tables, serverId, target, tableSelection);
        }
    }
}
