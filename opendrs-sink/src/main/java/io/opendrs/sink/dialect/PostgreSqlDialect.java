...
import io.opendrs.sink.util.BooleanUtil;
import io.opendrs.sink.util.ByteUtil;
import io.opendrs.sink.util.DurationUtil;
...
public class PostgreSqlDialect extends CommonDatabaseDialect {
    public PostgreSqlDialect(SinkConfig config) {
        super(config);
    }
    ...
    public static class PostgreSqlDialectProvider implements DatabaseDialectProvider {
        ...
        @Override
        public DatabaseDialect create(SinkConfig config) {
